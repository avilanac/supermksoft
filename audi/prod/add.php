                    ...
                    <form action="upadd.php" method="POST">
                        <div class="col-auto">
                            <div class="col-sm-9" id="title">
                                <h5 class="mb-0 ">Nueva Entrada Producto</h5>
                            </div>
                        </div>
                        <br>
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="varchar" class="form-control" readonly name="id" value="<?php echo $registro['cod']?>">
                            </div>
                        </div>
                        <br>
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="text" class="form-control" readonly name="prod" value="<?php echo $registro['prod']?>">
                            </div>
                        </div>
                        ...
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="number" class="form-control" readonly name="quant" value="<?php echo $registro['quant']?>">
                            </div>
                        </div>
                        <br>
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="number" class="form-control" name="entr" >
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="col-auto">
                            <div class="input-group col-md-6 align-items-right">
                                <input type="submit" name="edita" class="btn btn-success" id="entra" value="Ingresar">
