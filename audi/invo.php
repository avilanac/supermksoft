                    ...
                    <table class="table table-bordered border-danger table-striped ">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr class="table-light" >
                                ...
                                <td>   
                                    <a target="blank" href="anular.php?id=<?php echo $invoice->numb?> & fech=<?php echo $invoice->fech?>& nomc=<?php echo $invoice->id_cus?> & nomu=<?php echo $regis['nameu']?> & tot=<?php echo $invoice->value?> &esta=<?php echo $invoice->id_esta?>"><button type="button" class="btn btn-danger" >Anular</button> </a>
                                </td>
							    <td>   
