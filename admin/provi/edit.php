...
$sql="SELECT  * from providers  where nit=:id";//consulta con marcador, el marcador es :codigo
...
?>
                    ...
                    <form action="update.php" method="GET">
                        ...
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="number" class="form-control" name="id" readonly value="<?php echo $registro['nit']?>">
                            </div>
                        </div>
                        <br>
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="nom" value="<?php echo $registro['namep']?>">
                            </div>
                        </div>
                        <br>
                        <div class="col-auto">
                        ...
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="varchar" class="form-control" name="adre" value="<?php echo $registro['adress']?>">
                            </div>
                        </div>
                        <br>
                        <div class="col-auto">
    ...
    echo "No existe proveedir con NIT $busca";
}
