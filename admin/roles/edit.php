                    ...
                    <form action="update.php" method="GET">
                        ...
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="number" class="form-control" name="id" value="<?php echo $registro['id_rol']?>">
                            </div>
                        </div>
                        <br>
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="nom" value="<?php echo $registro['rol']?>">
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="col-auto">
                            <div class="input-group col-md-6 align-items-right">
                                <input type="submit" name="edita" class="btn btn-success" id="edita" value="Guardar">
                                
                                <a href="../roles.php"><input type="button" name="volver" class="btn btn-secondary" id="elimina" value="Volver"></a>
                            </div>
                        </div>
                    </form>
                </div>
