	...
	<div class="container-fluid h-100"> 
			<div class="row w-100 align-items-center">
				<div class="col text-center">
					...
					$resultado->execute(array(":id"=>$id, ":rol"=>$rol));
					echo "Se actualizó el rol $id ";
					?>
					<br><br>					
					<a href="../roles.php"><input type="button" name="volver" class="btn btn-danger" id="elimina" value="Volver"></a>
				</div>	
			</div>
    </div>
</body>
