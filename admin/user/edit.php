                    ...
                    <form action="update.php" method="GET">
                        ...
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="number" class="form-control" name="id" value="<?php echo $registro['id_usu']?>">
                            </div>
                        </div>
                        <br>
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="nom" value="<?php echo $registro['nameu']?>">
                            </div>
                        </div>
                        <br>
                        <div class="col-auto">
                        ...
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="varchar" class="form-control" name="user" value="<?php echo $registro['user']?>">
                            </div>
                        </div>
                        <br>
                        <div class="col-auto">
