...
$sql="SELECT  * from customers  where id_cus=:id";//consulta con marcador, el marcador es :codigo
                    ...
                    <form action="update.php" method="GET">
                        ...
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="number" class="form-control" name="id" readonly value="<?php echo $registro['id_cus']?>">
                            </div>
                        </div>
                        <br>
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="nom" value="<?php echo $registro['namec']?>">
                            </div>
                        </div>
                        <br>
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="ape" value="<?php echo $registro['lastna']?>">
                            </div>
                        </div>
                        <br>
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="number" class="form-control" name="tel" value="<?php echo $registro['tel']?>">
                            </div>
                        </div>
                        <br>
                        <div class="col-auto">
                            <div class="input-group col-md-6">
                                ...
                                <input type="varchar" class="form-control" name="adre" value="<?php echo $registro['adrc']?>">
                            </div>
                        </div>
                        <br>
                        <div class="col-auto">
