        ...
        <div class="col-md-10 col-sm-2 ">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="POST" enctype="multipart/form-data" id="formulario">
                                        <div class="form-group">
                                            ...
                                            <input type="int" name="usu" class="form-control" id="input" value="<?php echo $doc?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="id">Código</label>
                                            <input type="varchar" name="id" class="form-control" id="input1" aria-describedby="emailHelp" placeholder="">
                                        </div>
                                        <div class="form-group">
                                            <label for="id">Nombre</label>
                                            <input type="text" name="prod" class="form-control" id="Input2" aria-describedby="emailHelp" placeholder="">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="pre" class="form-control" id="exampleInputEmail1" 
                                                        aria-describedby="emailHelp" placeholder="">
                                        </div>
                                        <div class="form-group">
                                            <label for="id">Precio venta</label>
                                            <input type="number" name="prsale" class="form-control" id="exampleInputEmail1" 
                                                        aria-describedby="emailHelp" placeholder="">
                                        </div>
                                        <div class="form-group">
                                            <label for="id">Cantidad Inicial</label>
                                            <input type="number" name="quant" class="form-control" id="input3" 
                                                        aria-describedby="emailHelp" placeholder="">
                                        </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-4">
                    <strong>Total Unds Inventario: </strong>
                    </div>
                </div>
            </div>
        </div>
